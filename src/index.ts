...
async function transferSol(signer: Web3.Keypair,
    connection: Web3.Connection
    ) {
       const receiver = Web3.Keypair.generate();
       let transfer = Web3.SystemProgram.transfer({
        fromPubkey: signer.publicKey,
        toPubkey: receiver.publicKey,
        lamports: 100000000
       });

       let transaction = new Web3.Transaction().add(transfer);
...
async function main() {
    ...
    await transferSol(signer, connection);
}
